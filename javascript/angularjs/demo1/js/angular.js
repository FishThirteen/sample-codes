/**
 * @license AngularJS v1.3.0-local+sha.e7cf04b
...
function minErr(module, ErrorConstructor) {
  ...
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.3.0-local+sha.e7cf04b/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.3.0-local+sha.e7cf04b',    // all of these placeholder strings will be replaced by grunt's
